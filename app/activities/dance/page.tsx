...
const danceStyles = [
  {
    name: "Hip-hop",
    description: "Dynamic urban dance style perfect for all age groups (KIDS-TEENS-ADULTS)",
    image: "https://images.unsplash.com/photo-1535525153412-5a42439a210d?w=800&auto=format&fit=crop&q=60",
    features: ["Energetic movements", "Modern choreography", "Confidence building"],
    color: "from-[#f39318] to-[#FF5500]",
  },
  {
    name: "Bollywood",
    description: "Vibrant Indian dance style combining classical and contemporary elements",
    image: "https://images.unsplash.com/photo-1533450718592-29d45635f0a9?w=800&auto=format&fit=crop&q=60",
    features: ["Popular music", "Expressive movements", "Fun choreography"],
    color: "from-[#FF5500] to-[#f39318]",
  },
  {
    name: "Contemporary",
    description: "Modern dance form focusing on fluid movements and artistic expression",
    image: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=800&auto=format&fit=crop&q=60",
    features: ["Artistic expression", "Technical training", "Emotional connection"],
    color: "from-[#f39318] to-[#FF5500]",
  },
  {
    name: "Freestyle",
...
const benefits = [
  {
    ...
    description: "Burn 300-400 calories per session while improving agility, stamina, and strength",
    icon: "🏃‍♀️",
    color: "from-[#f39318] to-[#FF5500]",
  },
  {
    title: "Mental Wellness",
    description: "Dance and music work as therapy, making you stress-free by releasing happy hormones",
    icon: "🧘‍♀️",
    color: "from-[#FF5500] to-[#f39318]",
  },
  {
    title: "All Ages Welcome",
    description: "Classes for all age groups (KIDS-TEENS-ADULTS) with personalized attention",
    icon: "👥",
    color: "from-[#f39318] to-[#FF5500]",
  },
  {
...
export default function DancePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-6 text-gray-200">
              Standing among the reputed dance classes in Pune, Life Sports Academy provides a platform to learn various
              dance forms and showcase your talent.
            </p>
            <p className="text-lg mb-8 italic text-gray-300">
              "It doesn't matter what your age or what is your size, trust us you can dance."
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Transform every aspect of your personality - be it physical, spiritual, mental and emotional through your
              own style of dance. Dance is a type of art that connects your body to your soul to express your emotions
              strongly.
            </p>
          </div>
        </div>
      ...
      <section id="styles" className="py-20 bg-gradient-to-b from-white to-[#f39318]/5 relative overflow-hidden">
        <div className="container mx-auto px-4">
            ...
            {danceStyles.map((style, index) => (
              ...
              >
                ...
                <div className="p-6 relative">
                  <h3 className="text-xl font-semibold mb-2 text-gray-800">{style.name}</h3>
      ...
      <section id="enroll" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">Ready to Start Your Dance Journey?</h2>
            <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
              Join Life Sports Academy today and discover the joy of dance with our international-level, certified Dance
              Instructors. Transform your life through dance!
            </p>
